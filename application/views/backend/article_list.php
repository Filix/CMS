                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo site_url('backend/article/'.$article['aid'].'/delete') ?>" title="Delete" onclick="return confirm('你确定要这么做吗？')"><img src="<?php echo base_url(); ?>/public/images/backend/icons/cross.png" alt="Delete" /></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
