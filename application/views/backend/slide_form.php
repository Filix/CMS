            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                    ...
                    <p>
                        ...
                        <input class="text-input medium-input" max_length="50" type="text" id="small-input" name="title" value="<?php echo set_value('title') ? set_value('title') : $article['title']; ?>" />
                        <br /><small>最长50个字</small>
                    </p>
