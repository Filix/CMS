...
<div class="left">
    ...
    <div class="content">
        <div class="bg">
            ...
            <h3 style="margin-top: 10px;" class="title"><span>联系我们</span></h3>
            <div class="cont">
                <div class="text">
                    <div>联系人：洪雁</div>
                    <div>电 &nbsp;话：(86)0510-85329237</div>
                    <div>邮 &nbsp;编：214122</div>
                    <div>Email：hongyan@jiangnan<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.edu.cn</div>
...
<div class="center">
    <h3 class="title first">
        <a target="_blank" href="<?php echo site_url('category/1.html') ?>" ><span>热点新闻</span></a>
        <a target="_blank" style="margin-left:420px; font-size: 12px; color:#888;" href="<?php echo site_url('category/1.html') ?>" >更多</a>
    </h3>
<div class="text">
    <ul class="hot_news">
...
<h3 class="title first"><a target="_blank" href="<?php echo site_url('category/3.html') ?>" ><span>理事单位</span></a></h3>
<div class="advice">
                                    ...
                                    <td>
                                        <div class="indeximg">
                                            <a href="<?php echo site_url('article/'.$c['id'].'.html') ?>" target="_blank" title="<?php echo $c['title'] ?>">
                                                <img src="<?php echo base_url();?>uploads/<?php echo $c['img'] ?>" alt="<?php echo $c['title'] ?>" title="<?php echo $c['title'] ?>" width="240" height="100">
                                            </a>
    ...
    <div class="content">
        <div class="bg">
            ...
            <ul class="list">
                ...
                <?php endforeach; ?>
                <li style="background: none;" class="more"><a target="_blank" href="<?php echo site_url('category/6.html') ?>" title="更多">更多…</a></li>
            </ul>
        </div>
    </div>
    <div class="bottombg"><div></div></div>
    
    <div style="margin-top: 20px" class="topbg"><div></div></div>
    <div class="content">
        <div class="bg">
            <h3 class="title"><a target="_blank" href="<?php echo site_url('category/7.html') ?>"><span>会议信息</span></a></h3>
            <ul class="list">
                ...
                <?php endforeach; ?>
                <li style="background: none;" class="more"><a target="_blank" href="<?php echo site_url('category/7.html') ?>" title="更多">更多…</a></li>
            </ul>
        </div>
    </div>
    <div class="bottombg"><div></div></div>
...
<div style="margin-top: 20px" class="topbg"><div></div></div>
    <div class="content">
        <div class="bg">
            <h3 class="title"><a target="_blank" href="<?php echo site_url('category/2.html') ?>"><span>行业知识</span></a></h3>
            <ul class="list">
                <?php foreach($knowledge as $m): ?>
                <li>
                    <span></span>
                    <a target="_blank" title="<?php echo $m['title'] ?>" href="<?php echo site_url('article/'.$m['id'].'.html') ?>" ><?php echo mb_substr($m['title'],0, 16) ?></a>
                </li>
                <?php endforeach; ?>
                <li style="background: none;" class="more"><a target="_blank" href="<?php echo site_url('category/2.html') ?>" title="更多">更多…</a></li>
            </ul>
        </div>
    </div>
    <div class="bottombg"><div></div></div>
