<div id="head">
    ...
    <div class="sidebar">
        <div class="lang">
            ...
            <p class="time">今天是 <?php echo date('Y-m-d'); ?></p>
        </div>
    </div>
    ...
    <div class="nav">
        <ul>
            ...
            <li class="line"></li>
            <li class="class1">
                <a href="<?php echo site_url('intro.html') ?>" title="学会概况" class="class1<?php echo $focus == 'intro' ? ' navdown' : '';?>">
                    <span>协会概况</span>
                </a>
            </li>
            <li class="line"></li>
            ...
            <?php endforeach; ?>
            <li class="class1">
                <a href="<?php echo site_url('contactus.html') ?>" title="联系我们" class="class1<?php echo $focus == 'contactus' ? ' navdown' : '';?>">
                    <span>联系我们</span>
                </a>
    ...
    <div id="flash">
        ...
        <div class="content">
            <div class="flash">
                <img src="<?php echo base_url();?>public/images/ph.jpg" alt="" height="90" width="990">
            </div>
        </div>
        <div class="bottombg"></div>
    </div>
