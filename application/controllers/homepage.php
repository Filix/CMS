...
class homepage extends common {
	...
	public function index()
	{
        ...
        $notice = $this->article_model->getArticleByCategoryId(6, 3);
        $meeting = $this->article_model->getArticleByCategoryId(7, 3);
        $knowledge = $this->article_model->getArticleByCategoryId(2, 3);
        $summary = $this->article_model->getOneArticleByType(article_model::$SUMMARY);
        $links = $this->article_model->getArticlesByType(article_model::$LINK, 10);
	...
	$data = array(
	    ...
	    'main' => $this->load->view('frontend/homepage_main',
                                         array('hot' => $hotnews, 'notice' => $notice, 'meeting' => $meeting,'knowledge' => $knowledge,
